...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>网站内容管理 <span
        class="c-gray en">&gt;</span>
    编辑网站内容<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
             href="article/getArticleById.action?id=${article.articleid }" title="刷新"> <i
        class="Hui-iconfont">&#xe68f;</i></a>
    &nbsp;&nbsp; &nbsp;<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
                          href="article/getAllArticle.action" title="返回"> <i class="Hui-iconfont">&#xe66b;</i></a>
</nav>
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" action="updateArticle" name="myform"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select name="bannerid" class="select" id="bannerid">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" name="fileup" value="${article.image}">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <input type="hidden" name="addtime" id="addtime" value="${article.addtime}"/>
