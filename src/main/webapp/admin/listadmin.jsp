		...
		<table class="table table-border table-bordered table-bg">
			...
			<c:forEach items="${adminList}" var="admin">
				<tr class="text-c">
					...
					<td>${admin.addtime}</td>
					<td>
						<a href="/getAdminById?id=${admin.adminid}"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;
						<a href="/deleteAdminById?id=${admin.adminid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
			</c:forEach>
		</table>
