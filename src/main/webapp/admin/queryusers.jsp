...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>网站用户管理 <span
...
<div class="page-container">
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="12">网站用户查询</th>
        </tr>
        <tr class="text-c">
    ...
    <div class="text-c">
        <form action="queryUsersByCond" name="myform" method="post">
...
<%--                <option value="regdate">按注册日期查询</option>--%>
            ...
            关键字<input type="text" name="name" required
                      style="width: 200px"
                      class="input-text"/>
