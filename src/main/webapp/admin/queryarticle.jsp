...
<div class="page-container">
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="7">网站内容查询</th>
        </tr>
        <tr class="text-c">
            <th class="center">标题</th>
            <th class="center">网站</th>
    ...
    <div class="text-c">
        <form action="myQueryArticleByCond" name="myform" method="post">
            查询条件： <span class="select-box" style="width: 200px;">
            <select name="cond" class="select">
                <option value="title">按标题查询</option>
                <option value="bannerid">按网站查询</option>
...
<%--                <option value="hits">按点击数查询</option>--%>
            ...
            &nbsp;&nbsp;关键字<input type="text" name="name" required style="width: 200px" class="input-text"/>
